...
case "${1}" in
    ...
    faces)
        ...
        # run faces backend
        screen -dm -S visorgen-faces-backend-service bash -l -c 'cd /webapps/visorgen/; source ./bin/activate; cd /webapps/visorgen/vgg_face_finder/service; ./start_backend_service.sh'
