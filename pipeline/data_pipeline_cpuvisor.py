...
## The next two could be taken from the file CONFIG_PROTO_PATH, but the next version of the pipeline
## won't use a prototxt file, so leave it like this for now
IM_PATHS_FILE = 'dsetpaths.txt'
FEATURES_FILE = 'dsetfeats.binaryproto'
...
def data_processing_pipeline(input_list_of_frames, input_type, index, lock, DATASET_IM_BASE_PATH, DATASET_DATA_BASE_PATH,
                             CONFIG_PROTO_PATH = None, PREPROC_CHUNK_SIZE = None, feat_type='positive'):
...
#for index in range(len(all_lines)):
    ...
    #data_processing_pipeline(all_lines[index] , 'images', index, lock, DATASET_IM_BASE_PATH, DATASET_IM_PATHS + '.copy', None, CONFIG_PROTO_PATH, CHUNK_SIZE, 'positive')
